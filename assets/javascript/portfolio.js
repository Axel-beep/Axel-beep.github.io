...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            {
                name: 'instagram',
                link: 'https://www.instagram.com/noa_jaklin/'
            },
        ...
        if (window.mobileAndTabletCheck()) {
            $("#background").replaceWith('<div id="background" style="background-image: url(https://axel-beep.github.io/assets/images/Mobile Background.jpg);"></div>');
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[Axel]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>Discord Axel#3144</i>"], 120, 500, function () {
